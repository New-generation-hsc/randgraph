...
./bin/test/node2vec $DATASET nmblocks $NMBLOCKS sample its length 2 walkpersource 1

# ./bin/test/autoregressive $DATASET nmblocks $NMBLOCKS sample its length 2 walkpersource 1 dynamic
